			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-sm-3 form-group">
						...
						<select type="select" name="banco" class="form-control" id="banco" style="display: none;">
				...
				<div class="row">
					...
					<div class="col-sm-3 form-group">
						...
						<input type="number" name="numero_tarjeta" id="numero_tarjeta" class="form-control" min="0">
					</div>
					<div class="col-sm-3 form-group">
						<label class="control-label">Nombre de Tarjetahabiente:</label>
						<input type="text" name="nombre_tarjetaHabiente" id="nombre_tarjetaHabiente" class="form-control">
					</div>
					<div class="col-sm-3 form-group">
						<label class="control-label">Folio de Depósito:</label>
						<input type="number" name="numero_deposito" id="numero_deposito" class="form-control" min="0">
					</div>
					<div class="col-sm-3 form-group">
...
<script type="text/javascript">
	...
	{{-- FORMULARIO --}}
	{{-- <FORM id="thisform" method="POST" action="{{ route('clientes.pagos.store',['cliente'=>$cliente]) }}">{{ csrf_field() }}
		...
		<div class="row fset">
			...
			<div class="col-sm-3 form-group form-group nondisp" id="cheque">
			...
			<div class="col-sm-3 form-group form-group nondisp" id="tarjeta">
			...
			<div class="col-sm-3 form-group form-group nondisp" id="thabiente">
			...
			<div class="col-sm-3 form-group form-group nondisp" id="deposito">
