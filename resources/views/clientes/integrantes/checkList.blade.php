				...
				<div class="row">
					...
					<div class="col-sm-4 form-group">
						...
						<div class="row" id="archivo_identificacion_div">
							<img onClick="swipe();" style="max-width: 300px;" src="#" data-lightbox="image-1" alt="Tú imagen" id="archivo_identificacion_img">
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-sm-4 form-group">
						...
						<div class="row" id="archivo_comprobante_div">
							<img onClick="swipe();" style="max-width: 300px;" src="#" data-lightbox="image-1" alt="Tú imagen" id="archivo_comprobante_img">
						</div>
					</div>
					<div class="col-sm-4 form-group">
						<label class="control-label">Dirección:</label>
						<textarea required="" name="" id="" rows="4" class="form-control" style="resize: none;"></textarea>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-4 form-group">
					...
					<div class="col-sm-4 form-group">
						<div class="row">
							<label for="archivo_solicitud"
								style="font-size: 10px;font-weight: 600;color: #fff;border-radius: 5px;background-color: #1464dc;display: inline-block;transition: all .5s;cursor: pointer;margin-top: 15px;padding: 15px 40px !important;text-transform: uppercase;width: fit-content;text-align: center"><span>Subir
									Archivo</span></label>
							<span><input required="" class="inputfile" type="file" name="archivo_solicitud" id="archivo_solicitud"
									style="width: 0.1px;height: 0.1px;opacity: 0;overflow: hidden; position: absolute;z-index: -1"></span>
						</div>
						<div class="row" id="archivo_solicitud_div">
							<img onClick="swipe();" style="max-width: 300px;" src="#" data-lightbox="image-1" alt="Tú imagen" id="archivo_solicitud_img">
						</div>
					</div>
				</div>
				<div class="row">
							...
							<div class="col-sm-4 form-group">
								...
								<div class="row" id="archivo_pago_div">
									<img onClick="swipe();" style="max-width: 300px;" src="#" data-lightbox="image-1" alt="Tú imagen" id="archivo_pago_img">
								</div>
							</div>
