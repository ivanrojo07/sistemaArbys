...
@section('personal')
	...
	<ul role="tablist" class="nav nav-tabs nav-pills nav-justified">
    	<li class="ui-tabs-tab ui-corner-top ui-state-default ui-tab"><a href="{{ route('clientes.show',['cliente'=>$cliente]) }}" class="ui-tabs-anchor">Dirección/Domicilio:</a></li>
    	
    	
    
    	<li class="active"><a href="{{ route('clientes.crm.index',['cliente'=>$cliente]) }}" class="ui-tabs-anchor">C.R.M.:</a></li>
	</ul>
