				...
				<div class="col-sm-12">
					...
					<table class="table table-bordered table-stripped table-hover" style="margin-bottom: 0">
						...
						<tr>
							...
							<td>${{ !$transaction->product ? '' : number_format($transaction->product->precio_lista, 2) }}
							</td>
							<td>
								@if($solicitante == null)
								@foreach($solicitante as $sol)
								@if($transaction->product && $sol->clave_unidad == $transaction->product->clave)
								<a href="{{ route('clientes.solicitantes.edit', ['cliente' => $cliente, 'solicitante' => $sol]) }}"
									class="btn btn-primary">
									<i class="fa fa-pencil"></i><strong> Editar solicitud</strong>
								</a>
								<a href="{{ route('clientes.solicitantes.show', ['cliente' => $cliente, 'solicitante' => $sol]) }}"
									class="btn btn-warning">
									<i class="fa fa-eye"></i><strong> Ver </strong>
								</a>
								@else
								<a href="{{ route('clientes.solicitantes.create', ['cliente' => $cliente, 'clave' =>$transaction->product->clave, 'pagos' => $pagos->id]) }}"
		...
		<div class="row">
			...
			<div class="col-sm-4">
				<a class="btn btn-info btn-sm"
					href="{{ route('clientes.solicitantes.edit',['cliente'=>$cliente,'solicitante'=>$cliente->solicitante]) }}">
	...
	<div role="application" class="panel panel-group">
		<div class="panel-default">
			<div class="panel-heading">
				<h4>@if ($cliente->tipopersona == "Fisica")
		...
		<ul role="tablist" class="nav nav-tabs nav-pills nav-justified">
			<li role="tab" tabindex="0" aria-controls="tabs-1" aria-labelledby="ui-id-1" aria-selected="true"
				aria-expanded="true"
				class="ui-tabs-tab ui-corner-top ui-state-default ui-tab ui-tabs-active ui-state-active active"><a
					href="#tab1{{$cliente->id}}" tabindex="-1">Datos Generales:</a></li>
			<li role="tab" tabindex="-1" class="ui-tabs-tab ui-corner-top ui-state-default ui-tab"
				aria-controls="tabs-2" aria-labelledby="ui-id-2" aria-selected="false" aria-expanded="false"><a
					href="#tab2{{$cliente->id}}" role="tab" tabindex="-1" class="ui-tabs-anchor" id="ui-id-2">Datos para
					Cotización:</a></li>

			<li role="tab" tabindex="-1" class="ui-tabs-tab ui-corner-top ui-state-default ui-tab"
				aria-controls="tabs-3" aria-labelledby="ui-id-3" aria-selected="false" aria-expanded="false"><a
					href="#tab4{{$cliente->id}}" role="tab" tabindex="-1" class="ui-tabs-anchor" id="ui-id-3">CRM:</a>
			</li>
		</ul>
			...
			<div class="panel-body">
				<div class="col-md-12 offset-md-2 mt-3">
					...
					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
						...
						<dd>{{ $cliente->nombre }}&nbsp;&nbsp;{{ $cliente->apellidopaterno }}&nbsp;&nbsp;{{ $cliente->apellidomaterno }}
						</dd>
					</div>
					@else
					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
