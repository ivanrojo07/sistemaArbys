...
class CreateEmpleadoCDatosLaboralesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('empleado_c_datos_laborales', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('empleado_c_datos_laborales');
    }
}
