...
class CreateEmpleadoComDatosLabsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('empleado_com_datos_labs', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('empleado_comercial_id')->unsigned();
            $table->foreign('empleado_comercial_id')->references('id')->on('empleado_comercials');
    ...
    {
        Schema::dropIfExists('empleado_com_datos_labs');
    }
}
